...
mixin _$SingleBusinessStore on _SingleBusinessStoreBase, Store {
  late final _$isLikedAtom =
      Atom(name: '_SingleBusinessStoreBase.isLiked', context: context);
  ...
  set isLiked(bool value) {
    _$isLikedAtom
        .reportWrite(value, _isLikedIsInitialized ? super.isLiked : null, () {
      super.isLiked = value;
      _isLikedIsInitialized = true;
    });
  }

  late final _$isLikedPersonallyAtom = Atom(
      name: '_SingleBusinessStoreBase.isLikedPersonally', context: context);
  ...
  set isLikedPersonally(bool value) {
    _$isLikedPersonallyAtom.reportWrite(
        value, _isLikedPersonallyIsInitialized ? super.isLikedPersonally : null,
        () {
  ...
  late final _$countLikesAtom =
      Atom(name: '_SingleBusinessStoreBase.countLikes', context: context);
  ...
  set countLikes(int value) {
    _$countLikesAtom.reportWrite(
        value, _countLikesIsInitialized ? super.countLikes : null, () {
      super.countLikes = value;
      _countLikesIsInitialized = true;
    });
  }

  late final _$singleBusinessAtom =
      Atom(name: '_SingleBusinessStoreBase.singleBusiness', context: context);
  ...
  late final _$fetchStatusAtom =
      Atom(name: '_SingleBusinessStoreBase.fetchStatus', context: context);
  ...
  late final _$ipfsProductsAtom =
      Atom(name: '_SingleBusinessStoreBase.ipfsProducts', context: context);
  ...
  late final _$errorAtom =
      Atom(name: '_SingleBusinessStoreBase.error', context: context);
  ...
  late final _$getSingleBusinessAsyncAction = AsyncAction(
      '_SingleBusinessStoreBase.getSingleBusiness',
      context: context);
  ...
  @override
  void toggleLikes() {
    final _$actionInfo = _$_SingleBusinessStoreBaseActionController.startAction(
        name: '_SingleBusinessStoreBase.toggleLikes');
    try {
  ...
  void toggleOwnLikes() {
    final _$actionInfo = _$_SingleBusinessStoreBaseActionController.startAction(
        name: '_SingleBusinessStoreBase.toggleOwnLikes');
    try {
