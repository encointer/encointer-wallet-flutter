...
abstract class _BusinessesStoreBase with Store {
  ...
  Future<List<AccountBusinessTuple>> _bazaarGetBusinesses() {
    Log.d('_bazaarGetBusinesses: _cid = $_cid, _cid.toFmtString: ${_cid.toFmtString()}', _targetLogger);
  ...
  Future<void> getBusinesses() async {
    log('$_targetLogger: getBusinesses cid2: $cid2,  cid1: $cid1, ${cid1.toFmtString()}');
