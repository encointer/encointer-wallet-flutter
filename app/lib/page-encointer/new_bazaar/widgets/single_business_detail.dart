...
import 'package:encointer_wallet/page-encointer/new_bazaar/widgets/business_detail_text_widget.dart';
import 'package:encointer_wallet/page-encointer/new_bazaar/logic/like_icon_store.dart';
import 'package:encointer_wallet/page-encointer/new_bazaar/widgets/business_detail_address_widget.dart';
import 'package:encointer_wallet/page-encointer/new_bazaar/widgets/map_button.dart';
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    IconButton(
                      icon: Assets.avatars.participant00.svg(
                        height: 19,
