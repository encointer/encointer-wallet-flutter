...
MeetupOverrides _$MeetupOverridesFromJson(Map<String, dynamic> json) =>
    MeetupOverrides(
      ...
      (json['meetup-times'] as List<dynamic>?)
          ?.map((e) => DateTime.parse(e as String))
          .toList(),
    );

Map<String, dynamic> _$MeetupOverridesToJson(MeetupOverrides instance) =>
    <String, dynamic>{
      'override-name': instance.overrideName,
      'network': instance.network,
      'communities': instance.communities,
      'meetup-times':
          instance.meetupTimes?.map((e) => e.toIso8601String()).toList(),
    };
