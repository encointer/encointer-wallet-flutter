...
CommunityReputationV1 _$CommunityReputationV1FromJson(
        Map<String, dynamic> json) =>
    CommunityReputationV1(
...
Map<String, dynamic> _$CommunityReputationV1ToJson(
        CommunityReputationV1 instance) =>
    <String, dynamic>{
