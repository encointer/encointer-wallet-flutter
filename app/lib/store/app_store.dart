...
import 'package:encointer_wallet/common/stores/assets/assets_store.dart';
import 'package:encointer_wallet/common/stores/chain/chain_store.dart';
...
abstract class _AppStore with Store {
  ...
  Future<void> addAccount(
    ...
    Log.d('addAccount: acc = $acc, password = $password, address = $address, name = $name', _tag);
    await account.addAccount(acc, password, name: name);
  }
