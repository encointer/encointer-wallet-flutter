...
BazaarStore _$BazaarStoreFromJson(Map<String, dynamic> json) => BazaarStore(
      ...
      json['cid'] == null ? null : CommunityIdentifier.fromJson(json['cid'] as Map<String, dynamic>),
        ...
        ? ObservableList<AccountBusinessTuple>.of(
            (json['businessRegistry'] as List).map((e) => AccountBusinessTuple.fromJson(e as Map<String, dynamic>)))
        : null;
...
mixin _$BazaarStore on _BazaarStore, Store {
  late final _$businessRegistryAtom = Atom(name: '_BazaarStore.businessRegistry', context: context);
  ...
  late final _$_BazaarStoreActionController = ActionController(name: '_BazaarStore', context: context);
