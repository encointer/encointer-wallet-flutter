...
EncointerStore _$EncointerStoreFromJson(Map<String, dynamic> json) =>
    EncointerStore(
      ...
      ..phaseDurations = (json['phaseDurations'] as Map<String, dynamic>).map(
        (k, e) => MapEntry(
            $enumDecode(_$CeremonyPhaseEnumMap, k), (e as num).toInt()),
      )
...
mixin _$EncointerStore on _EncointerStore, Store {
  ...
  bool get meetupCompleted =>
      (_$meetupCompletedComputed ??= Computed<bool>(() => super.meetupCompleted,
              name: '_EncointerStore.meetupCompleted'))
          .value;
  ...
  SvgPicture get communityIconOrDefault => (_$communityIconOrDefaultComputed ??=
          Computed<SvgPicture>(() => super.communityIconOrDefault,
              name: '_EncointerStore.communityIconOrDefault'))
      .value;
  Computed<int?>? _$proposalEnactmentDateComputed;

  @override
  int? get proposalEnactmentDate => (_$proposalEnactmentDateComputed ??=
          Computed<int?>(() => super.proposalEnactmentDate,
              name: '_EncointerStore.proposalEnactmentDate'))
      .value;
  ...
  bool get showRestartCeremonyButton => (_$showRestartCeremonyButtonComputed ??=
          Computed<bool>(() => super.showRestartCeremonyButton,
              name: '_EncointerStore.showRestartCeremonyButton'))
      .value;
