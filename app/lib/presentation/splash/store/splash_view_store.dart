...
abstract class _SplashViewStore with Store {
  ...
  Future<void> _initWebApi(BuildContext context) async {
    ...
    if (buildConfig == BuildConfig.unitTest || !buildConfig.integrationTestConfig.testingRealApp) {
      webApi = MockApi(
        _appStore,
        MockJSApi(),
      ...
      webApi = Api.create(_appStore, JSApi(), SubstrateDartApi(), jsServiceEncointer);
    }
