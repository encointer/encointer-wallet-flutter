...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String proposalExplainerIssueSwapAssetOption(String cc, String asset) {
    return 'Это предложение позволяет получателю обменивать токены сообщества на $asset по установленному курсу несколько раз, до заданного лимита $asset. Получателем может быть местный бизнес, принимающий токены сообщества и накапливающий излишки.\n\nПример с курсом 3 $cc/$asset и лимитом 2 $asset:\n\nПолучатель может обменять до 2 $asset по курсу 3 $cc/$asset. Максимум — 6 $cc => 2 $asset.\n\nПримечание: Ты получишь $asset напрямую на Asset Hub Kusama.';
  }
