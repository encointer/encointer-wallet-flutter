...
void main() {
  setUpAll(() {
    // Point to the pre-built Linux native library.
    // When run via `flutter test`, CWD is the workspace root.
    nativeLibraryOverride = '${Directory.current.path}/packages/ew_zk_prover/native/linux/libew_zk_prover.so';
  });
