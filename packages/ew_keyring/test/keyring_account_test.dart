...
void main() {
  group('KeyringAccount', () {
    test('newValidated constructor works', () {
      ...
      final bob =
          KeyringAccount.newValidated('Bob', '0x398f0c28f98885e046333d4a41c19cee4c37368a9832c6502f6cfd182e2aef89');
      final bob2 =
          KeyringAccount.newValidated('Bob', '398f0c28f98885e046333d4a41c19cee4c37368a9832c6502f6cfd182e2aef89');
      final testAccount =
          KeyringAccount('TestAccount', 'spray trust gown toast route merge awful sight ghost all degree exit');
