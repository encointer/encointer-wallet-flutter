...
import 'pallets/balances.dart' as _i6;import 'pallets/encointer_balances.dart' as _i15;import 'pallets/encointer_bazaar.dart' as _i16;import 'pallets/encointer_ceremonies.dart' as _i13;import 'pallets/encointer_communities.dart' as _i14;import 'pallets/encointer_democracy.dart' as _i19;import 'pallets/encointer_faucet.dart' as _i18;import 'pallets/encointer_reputation_commitments.dart' as _i17;import 'pallets/encointer_scheduler.dart' as _i12;import 'pallets/grandpa.dart' as _i8;import 'pallets/proxy.dart' as _i9;import 'pallets/randomness_collective_flip.dart' as _i3;import 'pallets/scheduler.dart' as _i10;import 'pallets/sudo.dart' as _i5;import 'pallets/system.dart' as _i2;import 'pallets/timestamp.dart' as _i4;import 'pallets/transaction_payment.dart' as _i7;import 'pallets/treasury.dart' as _i11;import 'pallets/utility.dart' as _i20;class Queries {Queries(_i1.StateApi api) : system = _i2.Queries(api), randomnessCollectiveFlip = _i3.Queries(api), timestamp = _i4.Queries(api), sudo = _i5.Queries(api), balances = _i6.Queries(api), transactionPayment = _i7.Queries(api), grandpa = _i8.Queries(api), proxy = _i9.Queries(api), scheduler = _i10.Queries(api), treasury = _i11.Queries(api), encointerScheduler = _i12.Queries(api), encointerCeremonies = _i13.Queries(api), encointerCommunities = _i14.Queries(api), encointerBalances = _i15.Queries(api), encointerBazaar = _i16.Queries(api), encointerReputationCommitments = _i17.Queries(api), encointerFaucet = _i18.Queries(api), encointerDemocracy = _i19.Queries(api);
...
class Rpc {const Rpc({required this.state, required this.system, });
...
List getSignedExtensionTypes() { return  ['CheckMortality', 'CheckNonce', 'ChargeAssetTxPayment']; } 
List getSignedExtensionExtra() { return  ['CheckSpecVersion', 'CheckTxVersion', 'CheckGenesis', 'CheckMortality']; } 
 }
class EncointerKusama {EncointerKusama._(this._provider, this.rpc, ) : query = Queries(rpc.state), constant = Constants(), tx = Extrinsics(), registry = Registry();

factory EncointerKusama(_i1.Provider provider) { final rpc = Rpc(state: _i1.StateApi(provider), system: _i1.SystemApi(provider), );
return  EncointerKusama._(provider, rpc, ); }

factory EncointerKusama.url(Uri url) { final provider = _i1.Provider.fromUri(url);
...
_i21.Future connect() async  { return   await _provider.connect(); } 
_i21.Future disconnect() async  { return   await _provider.disconnect(); } 
 }
