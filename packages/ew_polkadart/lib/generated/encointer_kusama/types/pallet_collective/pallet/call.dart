...
class $Call {
  ...
  Kill kill({required _i5.H256 proposalHash}) {
    return Kill(proposalHash: proposalHash);
  }

  ReleaseProposalCost releaseProposalCost({required _i5.H256 proposalHash}) {
    return ReleaseProposalCost(proposalHash: proposalHash);
  }
}
...
class $CallCodec with _i1.Codec<Call> {
  ...
  Call decode(_i1.Input input) {
    ...
    switch (index) {
      ...
      case 8:
        return ReleaseProposalCost._decode(input);
      default:
  ...
  void encodeTo(
    ...
    switch (value.runtimeType) {
      ...
      case Kill:
        ...
        break;
      case ReleaseProposalCost:
        (value as ReleaseProposalCost).encodeTo(output);
        break;
      default:
  ...
  int sizeHint(Call value) {
    switch (value.runtimeType) {
      ...
      case ReleaseProposalCost:
        return (value as ReleaseProposalCost)._sizeHint();
      default:
        throw Exception('Call: Unsupported "$value" of type "${value.runtimeType}"');
    }
  }
...
class Kill extends Call {
  const Kill({required this.proposalHash});

  factory Kill._decode(_i1.Input input) {
    return Kill(proposalHash: const _i1.U8ArrayCodec(32).decode(input));
  }
  ...
  @override
  Map<String, Map<String, List<int>>> toJson() => {
        'kill': {'proposalHash': proposalHash.toList()}
      };
...
class ReleaseProposalCost extends Call {
  const ReleaseProposalCost({required this.proposalHash});

  factory ReleaseProposalCost._decode(_i1.Input input) {
    return ReleaseProposalCost(proposalHash: const _i1.U8ArrayCodec(32).decode(input));
  }
  ...
  @override
  Map<String, Map<String, List<int>>> toJson() => {
        'release_proposal_cost': {'proposalHash': proposalHash.toList()}
      };
