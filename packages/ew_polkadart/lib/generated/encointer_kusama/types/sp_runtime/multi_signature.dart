...
class $MultiSignature {
  ...
  Ed25519 ed25519({required _i3.Signature value0}) {
    return Ed25519(
      value0: value0,
    );
  }

  Sr25519 sr25519({required _i4.Signature value0}) {
    return Sr25519(
      value0: value0,
    );
  }

  Ecdsa ecdsa({required _i5.Signature value0}) {
    return Ecdsa(
      value0: value0,
    );
  }
...
class Ed25519 extends MultiSignature {
  const Ed25519({required this.value0});

  factory Ed25519._decode(_i1.Input input) {
    return Ed25519(
      value0: const _i1.U8ArrayCodec(64).decode(input),
    );
  }
...
class Sr25519 extends MultiSignature {
  const Sr25519({required this.value0});
...
class Ecdsa extends MultiSignature {
  const Ecdsa({required this.value0});

  factory Ecdsa._decode(_i1.Input input) {
    return Ecdsa(
      value0: const _i1.U8ArrayCodec(65).decode(input),
    );
  }
