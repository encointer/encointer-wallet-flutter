...
import '../pallet_encointer_offline_payment/pallet/event.dart' as _i22;
...
class $RuntimeEvent {
  ...
  EncointerOfflinePayment encointerOfflinePayment(_i22.Event value0) {
...
class EncointerOfflinePayment extends RuntimeEvent {
  ...
  factory EncointerOfflinePayment._decode(_i1.Input input) {
    return EncointerOfflinePayment(_i22.Event.codec.decode(input));
  }
