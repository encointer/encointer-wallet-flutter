...
import '../pallet_encointer_offline_payment/pallet/call.dart' as _i21;
...
class $RuntimeCall {
  ...
  EncointerOfflinePayment encointerOfflinePayment(_i21.Call value0) {
...
class EncointerOfflinePayment extends RuntimeCall {
  ...
  factory EncointerOfflinePayment._decode(_i1.Input input) {
    return EncointerOfflinePayment(_i21.Call.codec.decode(input));
  }
