...
class V2 extends VersionedXcm {
  ...
  factory V2._decode(_i1.Input input) {
    return V2(const _i1.SequenceCodec<_i6.Instruction>(_i6.Instruction.codec).decode(input));
  }
...
class V3 extends VersionedXcm {
  ...
  factory V3._decode(_i1.Input input) {
    return V3(const _i1.SequenceCodec<_i8.Instruction>(_i8.Instruction.codec).decode(input));
  }
...
class V4 extends VersionedXcm {
  ...
  factory V4._decode(_i1.Input input) {
    return V4(const _i1.SequenceCodec<_i9.Instruction>(_i9.Instruction.codec).decode(input));
  }
