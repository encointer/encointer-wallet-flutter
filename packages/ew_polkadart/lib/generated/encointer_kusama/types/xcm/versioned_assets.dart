...
class V2 extends VersionedAssets {
  ...
  factory V2._decode(_i1.Input input) {
    return V2(const _i1.SequenceCodec<_i6.MultiAsset>(_i6.MultiAsset.codec).decode(input));
  }
...
class V3 extends VersionedAssets {
  ...
  factory V3._decode(_i1.Input input) {
    return V3(const _i1.SequenceCodec<_i8.MultiAsset>(_i8.MultiAsset.codec).decode(input));
  }
...
class V4 extends VersionedAssets {
  ...
  factory V4._decode(_i1.Input input) {
    return V4(const _i1.SequenceCodec<_i9.Asset>(_i9.Asset.codec).decode(input));
  }
