...
import 'instruction_2.dart' as _i15;
...
class $Instruction {
  ...
  SetErrorHandler setErrorHandler({required _i13.Xcm value0}) {
    return SetErrorHandler(
      value0: value0,
    );
  }

  SetAppendix setAppendix({required _i13.Xcm value0}) {
    return SetAppendix(
      value0: value0,
    );
  }
...
class TransferReserveAsset extends Instruction {
  ...
  int _sizeHint() {
    ...
    size = size + const _i1.SequenceCodec<_i14.Instruction>(_i14.Instruction.codec).sizeHint(xcm);
    return size;
  }
...
class SetErrorHandler extends Instruction {
  ...
  factory SetErrorHandler._decode(_i1.Input input) {
    return SetErrorHandler(
      value0: const _i1.SequenceCodec<_i15.Instruction>(_i15.Instruction.codec).decode(input),
    );
  }
  ...
  int _sizeHint() {
    int size = 1;
    size = size + const _i1.SequenceCodec<_i15.Instruction>(_i15.Instruction.codec).sizeHint(value0);
    return size;
  }
