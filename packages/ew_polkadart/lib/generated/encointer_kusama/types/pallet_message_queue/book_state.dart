...
class $BookStateCodec with _i1.Codec<BookState> {
  ...
  BookState decode(_i1.Input input) {
    return BookState(
      ...
      readyNeighbours: const _i1.OptionCodec<_i2.Neighbours>(_i2.Neighbours.codec).decode(input),
  ...
  int sizeHint(BookState obj) {
    ...
    size = size + const _i1.OptionCodec<_i2.Neighbours>(_i2.Neighbours.codec).sizeHint(obj.readyNeighbours);
