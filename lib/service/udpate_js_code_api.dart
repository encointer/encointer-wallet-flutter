...
class UpdateJSCodeApi {
  ...
  static Future<Map?> getLatestVersion() async {
    try {
      ...
      Log.e(e.toString(), 'updateJsCodeApi', s);
  ...
  static int? getPolkadotJSVersion(GetStorage jsStorage, String networkName) {
  ...
  static String? getPolkadotJSCode(GetStorage jsStorage, String networkName) {
    final jsCode = jsStorage.read('$_jsCodeStorageKey$networkName');
    return jsCode;
  }

  static void setPolkadotJSCode(GetStorage jsStorage, String networkName, String code, int version) {
