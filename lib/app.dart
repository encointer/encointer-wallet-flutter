...
class _WalletAppState extends State<WalletApp> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      // _webApi = widget.config.mockLocalStorage
      //     ? MockApi(context.read<AppStore>(), MockJSApi(), MockSubstrateDartApi(), widget.config.js, withUi: true)
      //     : Api.create(context.read<AppStore>(), JSApi(), SubstrateDartApi(), widget.config.js);
      ...
      context.read<AppStore>().settings.changeLang(context, context.read<AppStore>().settings.localeCode);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Provider(
        create: (context) => (widget.config.mockLocalStorage
                ? MockApi(context.read<AppStore>(), MockJSApi(), MockSubstrateDartApi(), widget.config.js, withUi: true)
                : Api.create(context.read<AppStore>(), JSApi(), SubstrateDartApi(), widget.config.js))
            .init()
        ...
        child: MaterialApp(
          ...
          localizationsDelegates: [
            AppLocalizationsDelegate(context.watch<AppStore>().settings.locale),
          ...
          theme: context.watch<AppStore>().settings.theme,
