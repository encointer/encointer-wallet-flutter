...
describe('encointer', () => {
  ...
  describe('get tx fee estimate', () => {
    it('should get register_participant fees', async () => {
      // assert(true);
  ...
  it('should get register_attestation fees', async () => {
    const attestation = {
      claim:
          {
      ...
      signature: '0xe42545ed4ba0fb2ac1d006acded9f437de18d12bd6464b1f96df6b21acfe7a5874fe59c9ba590748c8a87e42e3cf351663640c720f962b758914cb189aac178f',
    ...
    const param = [[createType(registry, 'Vec<Attestation>', [attestation, attestation])]];
