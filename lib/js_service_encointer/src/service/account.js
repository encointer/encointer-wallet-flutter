...
import { TrustedCallMap, TrustedCallTypes } from '../config/trustedCall';
...
const RQ_TRUSTED_CALL_NAMES = Object.keys(TrustedCallTypes.TrustedCall._enum);
const RQ_TRUSTED_CALL_TYPES = Object.values(TrustedCallTypes.TrustedCall._enum);
