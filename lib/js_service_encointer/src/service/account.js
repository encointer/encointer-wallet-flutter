...
function hasNewClaimRewardsExtrinsic() {
  return (api.runtimeVersion.specName === parachainSpecName && api.runtimeVersion.specVersion >= 8) ||
    (api.runtimeVersion.specName === solochainSpecName && api.runtimeVersion.specVersion >= 18);
}
