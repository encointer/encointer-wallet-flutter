 ...
 */
export function getClaimOfAttendance (
  accountid,
  cindex,
  cid,
  mindex,
  ...
  const currencyIdentifier = createType(registry, 'CurrencyIdentifier', cid);
  send('log', `Location Provided: ${location.lat}, ${location.lon}`);
