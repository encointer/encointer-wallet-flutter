...
export async function subscribeCommunityIdentifiers (msgChannel) {
  console.log(`EncointerCommunities Name: ${pallets.encointerCommunities.name}`);
  console.log(`EncointerCommunities cids: ${pallets.encointerCommunities.calls.communityIdentifiers}`);
