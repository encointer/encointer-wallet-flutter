...
//not sure if this works, check with chrigi
export async function bazaarGetBusinesses (cid) {
  return await api.rpc.bazaar.getBusinesses(cid);
}

export async function bazaarGetOfferings (cid) {
  return await api.rpc.bazaar.getOfferings(cid);
}

export async function bazaarGetOfferingsForBusiness (cid, owner) {
  return await api.rpc.bazaar.getOfferingsForBusiness(cid, owner);
}
