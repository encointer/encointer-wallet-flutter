...
export async function remainingNewbieTicketsBootstrapper (cid, address) {
  console.log(`js-remainingNewbieTickets B 1 ${cid}`);
  console.log(`js-remainingNewbieTickets B 2 ${address}`);
  ...
  ]).catch((e) => console.log(`js-remainingNewbieTickets B 3 error ${e}`));
