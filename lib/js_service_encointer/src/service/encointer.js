...
import { communityIdentifiers, encointerCommunities } from '../config/sgx-master';
...
export async function subscribeCommunityIdentifiers (msgChannel) {
  return await api.query[encointerCommunities][communityIdentifiers]((cids) => {
...
export async function getCommunityIdentifiers () {
  const cids = await api.query[encointerCommunities][communityIdentifiers]();
