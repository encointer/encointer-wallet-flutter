...
function clientRequestTrustedCall (account, cid, trustedCall, params) {
  ...
  const callSigned = createType(api.registry, 'TrustedCallSigned', {
    call: call,
    nonce: 0,
    signature: signature
  });
...
export class Worker {
  ...
  getPubKey () {
    ...
    return this.sendRequest(clientRq, parseWorkerPubKey);
  }
