...
import { getCurrencyIdentifiers } from './encointer';
...
describe('worker', () => {
  ...
  describe('getWorkerPubKey method', () => {
    it('should return value', async () => {
      const result = await useWorker(WORKER_URL).getShieldingKey();
  ...
  describe('getTotalIssuance method', () => {
    it('should return value', async () => {
      ...
      expect(result).toStrictEqual({ last_update: 0, principal: 0 });
    });
  });
