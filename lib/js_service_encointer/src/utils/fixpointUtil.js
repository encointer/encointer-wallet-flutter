...
export function encodeDoubleToFixPoint (upper, lower) {
  assertLength(upper, lower);
  return (num) => {
    const [upperBits, lowerBits] = num.toString(2).split('.');
    assert(upperBits.length <= upper, 'Number is larger than maximum in '.concat(upper, 'bit'));
...
export const encodeDoubleToI4F4 = encodeDoubleToFixPoint(4, 4);

export const encodeDoubleToI8F8 = encodeDoubleToFixPoint(8, 8);

export const encodeDoubleToI16F16 = encodeDoubleToFixPoint(16, 16);

export const encodeDoubleToI32F32 = encodeDoubleToFixPoint(32, 32);

export const encodeDoubleToI64F64 = encodeDoubleToFixPoint(64, 64);
