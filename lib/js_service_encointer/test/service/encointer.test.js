...
describe('encointer', () => {
  ...
  describe('getClaimOfAttendance', () => {
    ...
    it('verifies json parsed claim', async () => {
      await cryptoWaitReady();
      const claimant = keyring.addFromUri('//Bob', { name: 'Bob default' });
      const claim = `{
        "claimant_public": "5FHneW46xGXgs5mUiveU4sbTyGBzmstUspZC92UhjJM694ty",
        "ceremony_index": 7,
        ...
        "timestamp": 1621334640000,
        "number_of_participants_confirmed": 3,
        "claimant_signature": {
            "sr25519":"0x968d50cbfdf22c3702b7fd812585e5d8d318cdb88d08a4fba4797918e03c3b1c61421534a459d42e8373b1a76b7495bcc8330e90bf198a1bb90dd073a522f683"
          }
        }`;
