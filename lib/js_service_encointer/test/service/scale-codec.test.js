...
describe('scale-codec', () => {
  ...
  describe('decode', () => {
    ...
    // Fixme: Don't skip, but we need to generate a new claim in the app with the new cid format.
    it.skip('can parse data from wallet when scanning the qr code', async () => {
