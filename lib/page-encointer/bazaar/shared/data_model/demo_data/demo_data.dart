...
final List<BazaarOfferingData> allOfferings = [
  ...
  BazaarOfferingData("asffgdh ", "Tasfd safd sfda sda sfdasfghdd el", 42,
      Image.network('https://picsum.photos/id/1016/160/100')),
  BazaarOfferingData(
      "Stamp Collection",
  ...
  BazaarOfferingData(
      ...
      423000,
      Image.network('https://picsum.photos/id/142/160/100')),
  BazaarOfferingData("one way trip", "Very expensive trip with no return",
      12000000, Image.network('https://picsum.photos/id/142/160/100')),
  BazaarOfferingData(
...
final List<BazaarBusinessData> allBusinesses = [
  ...
  BazaarBusinessData(
      ...
      Image.network('https://picsum.photos/id/1016/160/100'),
      OpeningHours(OpeningHoursForDay([OpeningInterval.fromString("7:00-20:00")]), OpeningHoursForDay([OpeningInterval.fromString("7:00-20:00")]), OpeningHoursForDay([OpeningInterval.fromString("7:00-20:00")]), OpeningHoursForDay([OpeningInterval.fromString("7:00-20:00")]), OpeningHoursForDay([OpeningInterval.fromString("7:00-20:00")]), OpeningHoursForDay([OpeningInterval.fromString("8:00-18:00")]), OpeningHoursForDay([])),
...
final List<BazaarItemData> newInBazaar = [
  allOfferings[0],
  allBusinesses[2],
  allOfferings[1],
  allOfferings[2]
...
final List<BazaarItemData> lastVisited = [
  allOfferings[0],
  allBusinesses[0],
  allOfferings[1]
];
