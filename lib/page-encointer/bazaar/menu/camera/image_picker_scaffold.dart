...
class ImagePickerScaffold extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
            I18n.of(context)!.translationsForLocale().bazaar.imagesAddRemove),
      ),
      body: Center(
      ...
      floatingActionButton: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: FloatingActionButton(
              onPressed: () {
                _onImageButtonPressed(imagePickerState, ImageSource.camera,
                    context: context);
              },
              heroTag: 'image2',
              tooltip:
                  I18n.of(context)!.translationsForLocale().bazaar.photoTake,
  ...
  void _onImageButtonPressed(ImagePickerState state, ImageSource source,
