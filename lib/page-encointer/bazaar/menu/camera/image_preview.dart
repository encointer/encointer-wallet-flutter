...
class ImagePreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Observer(
      builder: (_) => ListView(
        children: [
          if (imagePickerState.retrieveDataError != null)
            Text(imagePickerState.retrieveDataError!),
          ...
          Text(
              "${imagePickerState.images.length} ${I18n.of(context)!.translationsForLocale().bazaar.imagesAdded}"),
          Column(
