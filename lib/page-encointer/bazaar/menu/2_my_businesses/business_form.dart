...
class BusinessFormScaffold extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Provider<BusinessFormState>(
        ...
        child: Scaffold(
          appBar: AppBar(
            title: Text(
                I18n.of(context)!.translationsForLocale().bazaar.businessAdd),
          ),
              ...
              children: <Widget>[
                ElevatedButton(
                  child: Row(children: [
                    Icon(Icons.delete),
                    Text(
                        I18n.of(context)!.translationsForLocale().bazaar.delete)
                  ]),
                  onPressed: () {
                    // TODO modify state
                ...
                ElevatedButton(
                  child: Row(children: [
                    Icon(Icons.check),
                    Text(I18n.of(context)!.translationsForLocale().bazaar.save)
                  ]),
                  onPressed: () {
          ...
          children: [
            Expanded(
              ...
              child: Observer(
                builder: (_) => TextField(
                  ...
                  decoration: InputDecoration(
                    labelText:
                        I18n.of(context)!.translationsForLocale().bazaar.street,
            ...
            Expanded(
              child: Observer(
                builder: (_) => TextField(
                  onChanged: (value) =>
                      businessFormState.streetAddendum = value,
                  decoration: InputDecoration(
            ...
            Expanded(
              ...
              child: Observer(
                builder: (_) => TextField(
                  ...
                  decoration: InputDecoration(
                    labelText:
                        I18n.of(context)!.translationsForLocale().bazaar.city,
