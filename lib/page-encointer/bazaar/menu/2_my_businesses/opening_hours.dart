              ...
              children: [
                Observer(
                  builder: (BuildContext context) => IconButton(
                    color: day == openingHours.dayOnFocus
                ...
                Observer(
                  builder: (BuildContext context) => IconButton(
                    icon: Icon(
                      Icons.copy,
                      color: day == openingHours.dayToCopyFrom
                          ? Colors.lightGreenAccent
                          : Colors.blueGrey, // TODO
                    ),
                    iconSize: 36,
                    visualDensity: VisualDensity.compact,
                    padding: EdgeInsets.zero,
                ...
                Flexible(
                  child: Observer(
                    builder: (_) => ListView.builder(
                        ...
                        itemCount:
                            openingHoursForThisDay!.openingIntervals.length,
                        itemBuilder: (_, index) {
                          final interval =
                              openingHoursForThisDay.openingIntervals[index];
                          return Container(
                              width: 200,
                              child: Row(
                                children: [
