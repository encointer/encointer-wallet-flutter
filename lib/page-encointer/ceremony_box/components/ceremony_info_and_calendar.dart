...
class CeremonyInfoAndCalendar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Event calendarEventToAdd =
        CeremonyBoxService.createCalendarEvent(nextCeremonyDate, dic);
    bool showAddToCalendarIconButton =
        CeremonyBoxService.showAddToCalendarIconButton();
    return Column(
      children: [
        IconButton(
          icon: RotatedBox(
