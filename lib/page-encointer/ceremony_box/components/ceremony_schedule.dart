...
import 'ceremony_countdown.dart';
...
class CeremonySchedule extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool showCountDown =
        CeremonyBoxService.shouldShowCountdown(nextCeremonyDate);
      ...
      children: [
        showCountDown
            ? CeremonyDateLabelAbsolute(
                nextCeremonyDate: nextCeremonyDate, languageCode: languageCode)
...
class CeremonyDateLabelAbsolute extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String nextCeremonyHourMinute =
        '${DateFormat.Hm(languageCode).format(nextCeremonyDate)}';
    String nextCeremonyYearMonthDay = CeremonyBoxService.formatYearMonthDay(
        nextCeremonyDate, dic, languageCode);
...
class CeremonyDateLabelRelative extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String timeLeftUntilCeremonyStartsDaysHours =
        CeremonyBoxService.getTimeLeftUntilCeremonyStartsDaysHours(
            nextCeremonyDate);
...
class CeremonyDate extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final dic = I18n.of(context)!.translationsForLocale();
    final h2BlackTheme =
        Theme.of(context).textTheme.headline2!.copyWith(color: encointerBlack);
    String nextCeremonyYearMonthDay = CeremonyBoxService.formatYearMonthDay(
        nextCeremonyDate!, dic, languageCode);
    String nextCeremonyHourMinute =
        '${DateFormat.Hm(languageCode).format(nextCeremonyDate!)}';
