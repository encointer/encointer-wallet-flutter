...
class ImportAccountForm extends StatefulWidget {
  const ImportAccountForm(this.onSubmit, {Key? key}) : super(key: key);
              ...
              child: ListView(
                children: <Widget>[
                  ...
                  TextFormField(
                    ...
                    controller: _keyCtrl,
                    maxLines: 2,
                    validator: (value) => _validateAccountSource(context, value!),
                  ),
                ],
              ),
            ),
          ...
          PrimaryButton(
            ...
            onPressed: () async {
              if (_formKey.currentState!.validate() && !(_advanceOptions.error ?? false)) {
                context.read<AppStore>().account.setNewAccountName(_nameCtrl.text.trim());
                context.read<AppStore>().account.setNewAccountKey(_keyCtrl.text.trim());
