...
mixin _$AssetsStore on _AssetsStore, Store {
  ...
  late final _$balancesAtom =
      Atom(name: '_AssetsStore.balances', context: context);
  ...
  late final _$setAccountBalancesAsyncAction =
      AsyncAction('_AssetsStore.setAccountBalances', context: context);
