...
import 'package:encointer_wallet/extras/utils/extensions/shared_prefences_extensions.dart';
import 'package:encointer_wallet/extras/utils/extensions/string_extensions.dart';
...
class PreferencesService extends PreferencesStorage {
  ...
  Future<bool> setKV(String key, String value) async {
    return _prefs.setStringSafe(key, value);
  }
  ...
  Future<bool> setLocale(Locale? value) {
    return _prefs.setStringSafe(_localKey, value?.languageCode);
  }
  ...
  Future<bool> setBiometricEnabled(bool? value) {
    return _prefs.setBoolSafe(_biometricEnabledKey, value);
  }
  ...
  Future<void> setListString(String key, List<String> value) async {
    await _prefs.setStringListSafe(key, value);
  }
